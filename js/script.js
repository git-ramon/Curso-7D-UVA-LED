...
document.querySelector('.scrollToSection').addEventListener('click', function(event) {
	// Impedindo o comportamento padrão do link
	event.preventDefault();
	// Encontrando a seção com o ID "video"
	const videoSection = document.querySelector('#section-video-fanny');
